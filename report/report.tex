...
Our implementation allows the leader to propose and decide on a sequence of values in the same consensus instance. This model is similar to Multi-Paxos and results in a single instance of consensus deciding all the blocks. This optimization preserves the original algorithm’s safety properties and improves performance.
